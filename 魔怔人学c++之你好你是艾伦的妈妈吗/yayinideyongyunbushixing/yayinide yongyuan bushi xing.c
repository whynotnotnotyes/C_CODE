...
//{
//	struct stu s1;
//	//当这时拿struct stu这个结构体类型来创建一个s1这个变量的时候，这时候才占据空间
//	return 0;
//}
...
//#include <stdio.h>
//
//void test(void)  //void可以用于函数的返回类型和函数的参数
//{
//	printf("hehe\n");
//}
//
...
//原码，反码，补码
//计算机中的有符号数(整型 signed,浮点数不是以原反补形式存储的)有三种表示方法，即原码，反码和补码
